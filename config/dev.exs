...
config :game_app, GameAppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "y1v6qczKQWdAVeTx+Cv5HY5VZXbUDK6nrqqCr2xYSplK/FrmyIZpy5j9CBrgE0C9",
  watchers: [
...
config :game_app, GameAppWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/game_app_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
...
# Enable console logger in development
